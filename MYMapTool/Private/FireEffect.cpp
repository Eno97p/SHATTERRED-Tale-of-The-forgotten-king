...
HRESULT CFireEffect::Add_Components()
{
	...
	/* For.Com_Shader */
	if (FAILED(CGameObject::Add_Component(LEVEL_STATIC, TEXT("Prototype_Component_Shader_Fire"),
		TEXT("Com_Shader"), reinterpret_cast<CComponent**>(&m_pShaderCom))))
		return E_FAIL;

	/* For.Com_Texture */
	if (FAILED(CGameObject::Add_Component(LEVEL_STATIC, TEXT("Prototype_Component_Texture_FireDiffuse"),
		TEXT("Com_DiffuseTEX"), reinterpret_cast<CComponent**>(&m_pTextureCom[FIRE_DIFFUSE]))))
		return E_FAIL;

	if (FAILED(CGameObject::Add_Component(LEVEL_STATIC, TEXT("Prototype_Component_Texture_FireNoise"),
		TEXT("Com_NoiseTEX"), reinterpret_cast<CComponent**>(&m_pTextureCom[FIRE_NOISE]))))
		return E_FAIL;

	if (FAILED(CGameObject::Add_Component(LEVEL_STATIC, TEXT("Prototype_Component_Texture_FireAlpha"),
