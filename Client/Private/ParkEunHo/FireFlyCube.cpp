...
HRESULT CFireFlyCube::Initialize(void* pArg)
{
	...
	XMStoreFloat4(&vParticlePos, XMVector3TransformCoord(XMLoadFloat3(&m_OwnDesc->vOffset), ParentMat));
	CGameObject* Particle1 = EFFECTMGR->Generate_Particle(101, vParticlePos, this);
	m_Particles.emplace_back(Particle1);
	CGameObject* Particle2 = EFFECTMGR->Generate_Particle(102, vParticlePos, this);
	m_Particles.emplace_back(Particle2);
