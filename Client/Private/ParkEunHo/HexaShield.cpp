...
{
	if (FAILED(__super::Add_Component(LEVEL_STATIC, TEXT("Prototype_Component_Model_HexaShield_MK2"),
...
HRESULT CHexaShield::Generate_HexaHit()
{
	...
	EFFECTMGR->Generate_Particle(92, ParticlePos);
	EFFECTMGR->Generate_Particle(93, ParticlePos);
