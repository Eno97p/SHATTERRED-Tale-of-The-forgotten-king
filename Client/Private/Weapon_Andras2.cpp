#include "stdafx.h"
#include "..\Public\Weapon_Andras2.h"

#include "GameInstance.h"
#include "Player.h"


CWeapon_Andras2::CWeapon_Andras2(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CWeapon{ pDevice, pContext }
{
}

CWeapon_Andras2::CWeapon_Andras2(const CWeapon_Andras2& rhs)
	: CWeapon{ rhs }
{
}

HRESULT CWeapon_Andras2::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CWeapon_Andras2::Initialize(void* pArg)
{
...
void CWeapon_Andras2::Priority_Tick(_float fTimeDelta)
{
...
void CWeapon_Andras2::Tick(_float fTimeDelta)
{
...
HRESULT CWeapon_Andras2::Render()
{
...
HRESULT CWeapon_Andras2::Render_LightDepth()
{
...
void CWeapon_Andras2::Set_Active(_bool isActive)
{
...
HRESULT CWeapon_Andras2::Add_Components()
{
	/* For.Com_Collider */
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_GAMEPLAY, TEXT("Prototype_Component_Model_Weapon_Andras2"),
...
HRESULT CWeapon_Andras2::Bind_ShaderResources()
{
	if (FAILED(m_pShaderCom->Bind_Matrix("g_WorldMatrix", &m_WorldMatrix)))
		return E_FAIL;
...
CWeapon_Andras2* CWeapon_Andras2::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CWeapon_Andras2* pInstance = new CWeapon_Andras2(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed To Created : CWeapon_Andras2");
...
CGameObject* CWeapon_Andras2::Clone(void* pArg)
{
	CWeapon_Andras2* pInstance = new CWeapon_Andras2(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed To Cloned : CWeapon_Andras2");
		Safe_Release(pInstance);
	}
