...
public:
	...
	HRESULT Compute(_float3 dispatch);
...
public:
	static CComputeShader* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, const wstring& ShaderFilePath, _uint NumPasses, const _char** EntryPointNames);
