...
HRESULT CRenderTarget::Bind_SRV_Compute(CComputeShader_Texture* pComputeShader, const _char* pConstantName)
{
	return pComputeShader->Bind_SRV(pConstantName, m_pSRV);
}
